...
```{bash, eval=FALSE}
featureCounts -a iwgsc_refseqv2.1_annotation_200916_HC.gff3 \
              -o counts/output.txt \
              -g Parent \
              -T 64 \
              Aligned.out.sam
              
head counts/output.txt | cut -f 1,7 

featureCounts -a iwgsc_refseqv2.1_annotation_200916_HC.gff3 \
              -o counts/new_output.txt  \
              -T 64 \
              -g ID \
              -t mRNA \
              -p 
...
Table: Tabel met de eerste acht regels van een count matrix gebasseerd op één sample, namelijk Roots_Low Fe_1.

| Gene ID | Count |
|-|-|
| TraesCS1A03G0000200.1 | 34 |
| TraesCS1A03G0000400.1 | 32 |
| TraesCS1A03G0000600.1 | 7 |
| TraesCS1A03G0000800.1 | 43 |
| TraesCS1A03G0001000.1 | 0 |
| TraesCS1A03G0001200.1 | 0 |
| TraesCS1A03G0001300.1 | 2 |
| TraesCS1A03G0001400.1 | 3 |
