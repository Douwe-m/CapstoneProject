...
rawdata <- read.table(file = "~/Documents/project_analysis_of_gene_expression/CapstoneProject/Gene Level Raw Counts.csv", sep = ",", header = TRUE)
rawdata[2:13] <- lapply(rawdata[2:13], as.numeric)
# stukje code waardoor de tabel goed wordt weergegeven.
```
...
```{bash, eval=FALSE}
java -jar ../../Trimmomatic-0.39/trimmomatic-0.39.jar PE ../../raw_data/sample_SRR13114670/SRR13114670_1.fastq ../../raw_data/sample_SRR13114670/SRR13114670_1.fastq trimmed_SRR13114670_1_p.fastq trimmed_SRR13114670_1_u.fastq trimmed_SRR13114670_2_p.fastq trimmed_SRR13114670_2_u.fastq ILLUMINACLIP:TruSeq3-PE.fa:2:30:1 MINLEN:36 SLIDINGWINDOW:4:20 AVGQUAL:20
```
...
STAR --genomeDir wheat_genome/genome_indices \
     --readFilesIn trimmed_data/sample_SRR13114670/trimmed_SRR13114670_1_p.fastq trimmed_data/sample_SRR13114670/trimmed_SRR13114670_2_p.fastq \
     --runThreadN 80
```
